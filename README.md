...
- Price benchmarking for currently active students with one row per learner, sorted by price, including tutor wage, subscription/package progress, subscription timing, price segment size, and integrated price-review hints
